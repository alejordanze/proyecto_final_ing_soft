...
Scenario:
    ...
    When ingreso en el campo columnas 10
    Then deberia ver el mensaje "La dimension actual es de 10x0"

Scenario:
    Given visito la pagina simuladora
    When ingreso en el campo filas 15
    Then deberia ver el mensaje "La dimension actual es de 0x15"
Scenario: 
    Given visito la pagina simuladora
    When ingreso en el campo "columnas" 10 y en el campo "filas" 15
    And presiono el boton "guardar"
